...
Future skills in this plugin (`okr-workflow-pre-pmf`) will add a project-tracker category for Asana / Linear / Jira / monday integrations. They'll be added when those skills land.

## When each connector is used

- **`~~knowledge base`** — Searched at the start of every skill in the kit for prior Ikigai work, executive summary drafts, mission/values docs, and OKR history. Helps the kit pick up where you left off if you've worked through any of these before.
